...
class TwoLayerNet(object):
    ...
    def loss(self, X: np.ndarray, y: np.ndarray=None):
        ...
        if y is None:
          scores = out3  # softmax_loss(out3, None)          
        # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        # affine_backward(grads, cache3)
        dx, grads['W2'], grads['b2'] = affine_backward(dout, cache3)
        grads['W2']+=self.reg * self.params['W2']
        _, grads['W1'], grads['b1'] = affine_relu_backward(dx, (cache1, cache2))
