...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        self.params['W1'] = np.random.normal(loc=0, scale=weight_scale, size=(num_filters, 3, filter_size, filter_size))
        self.params['b1'] = np.zeros(shape=(num_filters))
        self.params['W2'] = np.random.normal(loc=0, scale=weight_scale, size=(int(num_filters*input_dim[1]/2*input_dim[2]/2), hidden_dim))
